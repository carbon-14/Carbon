...
namespace Level5_NS
{
    ...
    public:
        ...
        void Initialize()
        {
            m_mesh = ResourceManager::Create< MeshResource >( "level5/level5.bmh" );
        }
    ...
    public:
        ...
        void Initialize()
        {
            m_mesh          = ResourceManager::Create< MeshResource >( "level5/sphere.bmh" );

            m_textures[0]   = ResourceManager::Create< TextureResource >( "level5/crack_c.btx" );
            m_textures[1]   = ResourceManager::Create< TextureResource >( "level5/crack_n.btx" );
